using MalirosoBlog.Data.Extensions;
...
namespace MalirosoBlog.Data.Implementation
{
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public async Task<PagedList<T>> GetPagedItems(PagedRequestParameters parameters, Expression<Func<T, bool>> predicate = null, Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null)
        {
