...
namespace MalirosoBlog.Data.Interfaces
{
    public interface IRepository<T>
    {
        ...
        Task<PagedList<T>> GetPagedItems(PagedRequestParameters parameters, Expression<Func<T, bool>> predicate = null, Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null);
